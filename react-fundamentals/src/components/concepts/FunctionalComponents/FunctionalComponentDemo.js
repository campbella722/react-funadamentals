    ...
    return(
        <Container className='main'>
            <Row>
                ...
                <dl>
                    <dt>Can use state</dt>
                    <dd>With the 'useState' hook, functional components can now both render a display to the page and update the information
                        to be shown.</dd>
                    ...
                    <dt>return()</dt>
                    <dd>Must return a single element, but this element may have nester elements inside of it.</dd>
                </dl>
...
//fat arrow function - 3 fewer lines. Common in React...
